import 'dart:ui';
import 'package:busexpress/presentation/profil_screen.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:firebase_auth/firebase_auth.dart';

import 'AdminDashbord_screen.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  List<Map<String, dynamic>> _agencyDetails = []; // Détails des agences
        ...
        child: ListView(
          ...
          children: <Widget>[
              ...
              onTap: () {
                ...
                if (userId.isNotEmpty) {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(content: Text('Veuillez vous connecter pour accéder au profil')),
                  );
                }
              },
            ),
            ...
            ListTile(
              ...
              title: const Text('Créer Agence'), // Nouveau bouton
              onTap: () {
                Navigator.pop(context); // Ferme le tiroir
                Navigator.push(
                  context,
